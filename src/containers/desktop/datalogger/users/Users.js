...
export default function Users() {
  const { columns, total, limit, offset, setLimit, setOffset, setTotal } =
    useUsers();
  ...
  useEffect(() => {
    ...
    setTimeout(async () => {
      try {
        ...
        loginService.handleMissingInfo(error, "Failed to get users list") &&
        ...
        <FormInput>
          <div className={styles.right_header}>
            ...
            <div
              ...
              onClick={() => openModal(actionOption.Add.action)}
            >
              <div className={styles.add}>
                <Button.Image image={<AddIcon />} title="Add new user" />
              </div>
            </div>
          </div>
        </FormInput>
          ...
          actions={(item) => (
            <div className="d-flex flex-wrap justify-content-center">
              ...
              <Button.Image
                ...
                title="Delete"
                onClick={() =>
                  openModal(actionOption.ConfirmDelete.action, {
                    email: item?.email,
                    id: item?.id,
                  })
                }
              ...
              <Button.Image
                ...
                onClick={() =>
                  openModal(actionOption.ResetPassword.action, {
                    email: item?.email,
                    id: item?.id,
                  })
                }
