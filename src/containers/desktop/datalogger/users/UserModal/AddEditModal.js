...
export default function AddEditModal({
  ...
  const handleSave = (data) => {
    ...
    let url =
      isOpenModal?.action === actionOption.Add.action
        ? Constants.API_URL.USERS.ADD
        : Constants.API_URL.USERS.UPDATE;
    ...
    setTimeout(async () => {
      try {
        ...
        loginService.handleMissingInfo(error, "Failed to add or edit user") &&
  ...
  return (
    <FormInput
      ...
      initialValues={isOpenModal?.user}
      onSubmit={handleSave}
    >
      <Modal
        isOpen={true}
