      ...
      <div className={styles.form_body}>
        <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="col-md-6">
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    {...register("ip_address", {
                      required: "Please fill the ip address",
                      pattern: {
                        value: Constants.REGEX_PATTERN.IP_ADDRESS,
                ...
                <div className="mb-3">
                  ...
                  <input
                    ...
                    {...register("subnet_mask", {
                      required: "Please fill the subnet mask",
                      pattern: {
                        value: Constants.REGEX_PATTERN.IP_ADDRESS,
                  ...
                  {errors.subnet_mask && (
                    <span className="validate">
                      {errors.subnet_mask.message}
                    </span>
                  )}
                </div>
                <div className="mb-3">
                  <label className="control-label">{t("site.gateway")}</label>
                  <input
                    className={
                      errors.gateway
                        ? "form-control input-error"
                    ...
                    {...register("gateway", {
                      required: "Please fill the gateway",
                      pattern: {
                        value: Constants.REGEX_PATTERN.IP_ADDRESS,
                ...
                <div className="mb-3">
                  <label className="control-label">{t("site.mtu")}</label>
                  <input
                    title={t("site.mtu_note")}
                    className={
                      errors.mtu ? "form-control input-error" : "form-control"
                    }
                    id="mtu"
                    name="mtu"
                ...
                <div className="mb-3">
                  <label className="control-label">{t("site.dns1")}</label>
                  <input
                    className={
                      errors.dns1 ? "form-control input-error" : "form-control"
                    }
                    id="dns1"
                    name="dns1"
                ...
                <div className="mb-3">
                  <label className="control-label">{t("site.dns2")}</label>
                  <input
                    className={
                      errors.dns2 ? "form-control input-error" : "form-control"
                    }
                    id="dns2"
                    name="dns2"
                      ...
                      <span className="me-2">
                        ...
                        >
                          <g transform="translate(1.4065934065934016 1.4065934065934016) scale(2.81 2.81)">
                            <path
                              className="st0"
                              d="M88,90H2c-1.1,0-2-0.9-2-2V2c0-1.1,0.9-2,2-2h65.8c0.5,0,1,0.2,1.4,0.6l20.2,20.2c0.4,0.4,0.6,0.9,0.6,1.4V88
          C90,89.1,89.1,90,88,90z M4,86h82V23L67,4H4V86z"
                            />
                            <path
                              className="st0"
                              d="M71.8,90H18.2c-1.1,0-2-0.9-2-2V48.2c0-1.1,0.9-2,2-2h53.7c1.1,0,2,0.9,2,2V88C73.8,89.1,72.9,90,71.8,90z
          M20.2,86h49.7V50.2H20.2V86z"
                            />
                            <path
                              className="st0"
                              d="M54.4,21.6H18.2c-1.1,0-2-0.9-2-2V2c0-1.1,0.9-2,2-2h36.3c1.1,0,2,0.9,2,2v17.6C56.4,20.8,55.5,21.6,54.4,21.6
          ...
          C90,89.1,89.1,90,88,90z M4,86h82V23L67,4H4V86z"
                            ...
                            <path
                              className="st0"
                              d="M62.7,60.3H27.3c-1.1,0-2-0.9-2-2s0.9-2,2-2h35.4c1.1,0,2,0.9,2,2S63.8,60.3,62.7,60.3z"
                            />
                            <path
                              className="st0"
                              d="M62.7,70.1H27.3c-1.1,0-2-0.9-2-2s0.9-2,2-2h35.4c1.1,0,2,0.9,2,2S63.8,70.1,62.7,70.1z"
                            />
                            <path
                              className="st0"
                              d="M62.7,79.8H27.3c-1.1,0-2-0.9-2-2s0.9-2,2-2h35.4c1.1,0,2,0.9,2,2S63.8,79.8,62.7,79.8z"
                            />
                          </g>
                        </svg>
                      </span>
