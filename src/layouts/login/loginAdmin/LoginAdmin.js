...
const LoginAdmin = () => {
  ...
  const schema = yup.object().shape({
    email: yup
      .string()
      .matches(
        Constants.REGEX_PATTERN.EMAIL,
        t("requiredMessage.email_pattern")
      )
      .required(t("requiredMessage.email")),
    password: yup
      .string()
      .matches(
        Constants.REGEX_PATTERN.PASSWORD,
        t("requiredMessage.password_pattern")
      )
      .required(t("requiredMessage.password")),
  });
          ...
          <div className={styles.body_login}>
            ...
            <div className="position-relative mb-3">
              <FormInput.Text
                ...
                invalidClassName={styles.form_validate}
              />
