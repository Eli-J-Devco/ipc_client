...
const LoginAdmin = () => {
    ...
    const onSubmit = (data) => {
        ...
        axios.post(Constants.API_HOST + "" + Constants.API_URL.AUTH, params, {
            headers: {
            ...
            onUploadProgress: ({ loaded, total, progress }) => {
                console.log("aaa: " , loaded, total, progress);
            ...
            onDownloadProgress: ({loaded, total, progress}) => {
                console.log("onDownloadProgress", loaded, total, progress);
            }
                ...
                <div className={styles.body_login}>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className={styles.form_group}>
                            ...
                            {errors.email && <span className={styles.validate}>{errors.email.message}</span>}
                        ...
                        <div className={styles.form_group}>
                            <input
                                ...
                                {...register("password", {
                                    ...
                                    pattern: {
                                        value: /^(?=.*[0-9])(?=.*[A-Z])(?=.*[a-z])(?=.*[~`!@#$%^&*()--+={}\[\]|\\:;"'<>,.?/_₹])[a-zA-Z0-9~`!@#$%^&*()--+={}\[\]|\\:;"'<>,.?/_₹]{7,}$/,
