                            ...
                            <div className={styles.user_menu}>
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <svg xmlns='http://www.w3.org/2000/svg' className='ionicon' viewBox='0 0 512 512'><title>Chevron Down</title><path fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' strokeWidth='30' d='M112 184l144 144 144-144' /></svg>
                                        <ul>
                                            <li>
                                            ...
                                            <li>
                                                <svg aria-hidden="true" width="512px" height="512px" viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" >
                                                    <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                                                        <g transform="translate(50.378500, 42.000000)" stroke="currentColor" strokeWidth="32">
